---
permalink: /knowledgefund/diagram/
layout: single
title: "KnowledgeFund Diagram"
excerpt: "A simple visual map of how KnowledgeFund fits together."
author: max
header:
...
{% include nav_list.html nav="knowledgefund" navtype="ol" navstyle="list-style-type: decimal" showtitle=false %}
...
flowchart TD
    ...
    C --> D[Starting ontology<br/>structure<br/>connections<br/>working methods]
    D --> E[KnowledgeFund Model]
    E --> F[Organisational memory<br/>contribution<br/>traceability<br/>AI legibility]
